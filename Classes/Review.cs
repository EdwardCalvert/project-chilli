...
namespace BlazorServerApp.Models
{
    public class Review
    {
        ...
        {
            return new { recipeID = RecipeID, reviewersName = ReviewersName, reviewTitle = ReviewTitle, reviewText = ReviewText, starCount = Star.GetNumberOfStars(), dateSubmitted = DateSubmitted, InappropriateContent,ReviewID = ReviewID };
        }
